            ...
            <ul className="space-y-3 ">
              {navLinks.map((link) => (
                <li key={link.text}>
                  <a 
                    href={link.href} 
                    className="group relative inline-block text-base-content/80 hover:text-base-content transition-colors duration-300"
                  >
                    {link.text}
            ...
            <div className="flex gap-4 ">
              {socialLinks.map((social) => (
                <a
                  ...
                  title={social.title}
                  className="text-2xl hover:text-primary transition-colors duration-300 hover:-translate-y-1 transform"
                >
                  {social.icon}
                </a>
              ))}
